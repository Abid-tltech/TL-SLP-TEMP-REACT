    ...
    <>
      <div className="backgroundImg flex justify-center w-full  h-screen ">
        ...
        <div className="zoom w-[60%] pt-10 pb-10">
          ...
          <div className="">
            <div className="flex justify-between h-[100px]">
              <div class="nav flex justify-center">
                <p class="text-white text-5xl font-bold grid place-content-center text-shadow tracking-wider hidden sm:block">
                  BRAND NAME
                </p>
              </div>
          ...
          {/* <==================== BODY ====================>  */}
          <div className="grid grid-cols-2 gap-x-5 justify-center items-center">
          ...
          {/* <==================== FOOTER ====================>  */}
          <div className="md:w-[1020px] w-[300px] mt-[20px] md:mt-2">
            <div className="mt-0">
